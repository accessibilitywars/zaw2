...
10. W4 Mursaat Overseer - Improved alacrity will allow you to claim tiles faster than other class. Using {{ skill(id="29830") }} to duplicate {{ chatlink(code="[&BhCUAAA=]") }} will allow you to claim tiles even faster, especially useful in CM. 
